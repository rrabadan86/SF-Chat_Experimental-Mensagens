    ...
    <div class="inbox-grid">
      <div>
        ...
        <div style="margin-bottom:8px">
          <button type="button" id="convImportBtn" onclick="importarHistorico()" class="reset" style="width:100%;font-size:.75rem;padding:6px" title="Traz para o painel as conversas antigas que o WhatsApp já sincronizou">📥 Importar histórico do WhatsApp</button>
