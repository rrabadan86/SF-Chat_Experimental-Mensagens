...
//
// Por que um patcher no boot (em vez de patch-package): a lib vem do GitHub
// (#main) e é reinstalada às vezes; este patcher é IDEMPOTENTE e roda a cada
// start, então sobrevive a `npm install` e se espalha pelas unidades via git.
// NUNCA derruba o processo (tudo em try/catch).
const fs = require('fs');
